...
| FEAT-002 | Fix or rebuild metrics system    | NOT_STARTED | None            | 2026-03-22 | src/queuelink/metrics.py                                                                                           |
...
|----|-------|------|------------|
| REVIEW-001 | Architectural review — full source read | 2026-03-22 | 14 (item 15 resolved) |
...
- FEAT-003: Plan drafted at tasks/FEAT-003/PLAN.md. Three open questions require human input before work begins (relocate vs. fix-in-place, SQLite vs. simpler storage, handle-adapter scope).
